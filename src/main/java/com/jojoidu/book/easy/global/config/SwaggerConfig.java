package com.jojoidu.book.easy.global.config;
...
import com.jojoidu.book.easy.global.dto.ErrorResponse;
...
public class SwaggerConfig {
	...
	public OpenAPI openAPI() {
		Info info = new Info()
			.title("Easy API Document")
			.version("1.0")
			.description(
				"환영합니다! API 문서는 EASY의 API를 사용하는 방법을 설명합니다.\n")
